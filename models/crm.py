...
class CRMLead(models.Model):
    ...
    street = fields.Char(string="Address 1", related='partner_id.street' )
    street2 = fields.Char(string="Address 2", related='partner_id.street2')
    city = fields.Char(string="City/Town", related='partner_id.city')
